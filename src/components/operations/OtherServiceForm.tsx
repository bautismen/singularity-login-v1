                      ...
                      <div className={styles.firstColumn}>
                        ...
                        <div className={styles.fieldGroup}>
                          <label className={styles.fieldLabel}>
                            ...
                            <select
                              value={serv.orderService.idTypeShipment || ''}
                              className={styles.selectInput}
                              required
                              onChange={(e) => {
                               // onUpdateServiceFormData(serv.idServiceItem, serv.orderService.sequence, 'idTypeShipment', Number(e.target.value))
                                //onUpdateServiceFormData(item, serv.orderService.sequence, 'typeShipment', e.target.options[e.target.selectedIndex].text)
                              }}>
